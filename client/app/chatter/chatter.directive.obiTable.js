define(["index.module"], function () {
  ...
  angular
    .module('bm.platform')
    .directive("obiTable", ['BIGate', '$timeout', '$http', 'metaDataResponses','$compile', OBITableDirective])
  ...
  function OBITableDirective(BIGate, $timeout, $http, metaDataResponses,$compile) {
    return {
      restrict: 'A',
      replace: true,
      transclude: false,
      ...
      compile: function (tElement, attrs) {
       ...
       // if (currentTableCells.attr('obi-table-cell') == 'true') return;

        currentTableCells.attr('obi-table-cell', 'true');

       // currentTableCells.attr('ng-dblclick', 'cellCtrl.showChatter()');


      /*  $.each(currentTableCells, function (index, item) {

          //currentTableCells[index].setAttribute('ng-dblclick', 'cellCtrl.showChatter("' +  currentTableCells[index].getAttribute('id')  + '")');

          currentTableCells[index].setAttribute('ng-click', 'cellCtrl.showChatter()');
...
*/
        ...
        //tElement.attr('bi-chatter-table-cell', 'true');
